...
0                      CompIce     - 
---------------------- INPUT FILES ---------------------------------------------
"RotorSE_FAST_IEA37_offshore_RWT_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"iea10MW_BeamDyn.dat"  BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"iea10MW_BeamDyn.dat"  BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"iea10MW_BeamDyn.dat"  BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"RotorSE_FAST_IEA37_offshore_RWT_InflowFile.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"RotorSE_FAST_IEA37_offshore_RWT_AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"RotorSE_FAST_IEA37_offshore_RWT_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
...
2.0                    SttsTime    - Amount of time between screen status messages (s)
