...
REAL(4), PARAMETER           :: PC_KI         =       0.28726                   ! Integral gain for pitch controller at rated pitch (zero), (-).
...
REAL(4), PARAMETER           :: PC_KP         =       1.91505                   ! Proportional gain for pitch controller at rated pitch (zero), sec.
REAL(4), PARAMETER           :: PC_MaxPit     =       1.570796                  ! Maximum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_MaxRat     =       0.174444                  ! Maximum pitch  rate (in absolute value) in pitch  controller, rad/s.
REAL(4), PARAMETER           :: PC_MinPit     =       0.000000                  ! Minimum pitch setting in pitch controller, rad.
REAL(4), PARAMETER           :: PC_RefSpd     =     0.90846                     ! Desired (reference) HSS speed for pitch controller, rad/s.
...
REAL(4), PARAMETER           :: VS_CtInSp     =    0.005                         ! Transitional generator speed (HSS side) between regions 1 and 1 1/2, rad/s.
REAL(4), PARAMETER           :: VS_DT         =    0.000125                     ! Communication interval for torque controller, sec.
REAL(4), PARAMETER           :: VS_MaxRat     =   15000000000.0                     ! Maximum torque rate (in absolute value) in torque controller, N-m/s.
REAL(4), PARAMETER           :: VS_MaxTq      =   13423770.86912                ! Maximum generator torque in Region 3 (HSS side), N-m. -- chosen to be 10% above VS_RtTq      = 000000.0 = 43.09355kNm
Real(4), PARAMETER           :: VS_RtTq       =   12203428.06284                ! Rated generator torque, Nm.
REAL(4), PARAMETER           :: VS_Rgn2K      =     6199875.503                 ! Generator torque constant in Region 2 (HSS side), N-m/(rad/s)^2.
REAL(4), PARAMETER           :: VS_Rgn2Sp     =     0.01                  ! Transitional generator speed (HSS side) between regions 1 1/2 and 2, rad/s.
...
REAL(4), PARAMETER           :: VS_RtGnSp     =     0.90846                     ! Rated generator speed (HSS side), rad/s. -- chosen to be 100% of PC_RefSpd
REAL(4), PARAMETER           :: VS_RtPwr      =   10638297.872340426            ! Rated generator power in Region 3, Watts. -- chosen to be 10MW divided by the electrical generator efficiency of 94.0%
...
IF ( iStatus == 0 )  THEN  ! .TRUE. if we're on the first call to the DLL
   ...
   ErrMsg   = 'Running with torque and pitch control of the NREL Baseline '// &
              ...
              'sowento GmbH. The controller has been tuned for use by Pietro Bortolotti.'
